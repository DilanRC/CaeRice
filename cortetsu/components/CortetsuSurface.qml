...
Rectangle {
    ...
    property color outlineColor: active || danger ? CortetsuDesign.colorVermillion : CortetsuDesign.colorOutlineVariant

    radius: radiusValue
    color: pressed ? Qt.darker(active ? activeColor : hoverColor, 1.12) : active ? activeColor : hovered ? hoverColor : baseColor
    border.width: outlined ? CortetsuDesign.outlineWidth : 0
