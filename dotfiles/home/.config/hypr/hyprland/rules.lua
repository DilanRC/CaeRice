...
-- GenGCF exposes its editor and a blank legacy helper as separate XWayland windows.
hl.window_rule({
    name           = "gengcf-editor",
    match          = { class = "gengcf.exe", title = "Gen-GCF.*" },
    float          = false,
    suppress_event = "maximize",
})
hl.window_rule({
    name             = "gengcf-hidden-helper",
    match            = { class = "gengcf.exe", title = "Generador de archivos para Graphing Calculator" },
    workspace        = "special:gengcf-helper",
