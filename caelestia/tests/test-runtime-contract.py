...
for marker in (
    ...
    'canonical="cortetsu-${name#caerice-}"', "cortetsu-rollback",
    "install-theme-bridge.py", "systemctl --user daemon-reload",
):
...
print("PASS: Cortetsu staged runtime, complete helper installation, atomic rollback, and Calendar lifecycle contract")
