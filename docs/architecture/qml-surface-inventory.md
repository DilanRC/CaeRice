...
| Notifications | `modules/notifications/Wrapper.qml`, `Content.qml`, `Notification.qml` | notification model, action list, scroll container | FUNCTIONAL | grouping, urgency, keyboard and empty states | P1 |
...
| Toasts | `modules/utilities/toasts/Toasts.qml`, `ToastItem.qml` | toaster service, action rows | FUNCTIONAL | urgency, expiration, stacking and dismissal | P1 |
| Overview | `modules/overview/Wrapper.qml`, `Content.qml`, `WindowCard.qml` | Hyprland windows/workspaces | SKELETON | composition, scaling, keyboard and monitor awareness | P0 |
