...
AUTO_SRC="$REPO/cortetsu/bin/cortetsu-power-auto"
AUTO_DST="$HOME/.local/bin/cortetsu-power-auto"
AUTO_CTL_SRC="$REPO/cortetsu/bin/cortetsu-power-auto-control"
AUTO_CTL_DST="$HOME/.local/bin/cortetsu-power-auto-control"
KEYBINDS_SRC="$REPO/cortetsu/bin/cortetsu-keybinds"
