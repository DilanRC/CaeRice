...
echo; echo "==> 8/9 Display + Wallpaper Manager + purge de centros retirados"; bash "$REPO/scripts/features/update-sad.sh"
...
echo "Runtime retenido: Bottom Hub, Overview, Clipboard, Hardware Center, Display Manager y Wallpaper Manager."
