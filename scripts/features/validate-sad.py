...
retired_paths = [
    ...
    "caelestia/bin/cortetsu-gaming-probe",
    "caelestia/bin/cortetsu-gaming-profile",
    "caelestia/bin/cortetsu-upstream-audit",
    "caelestia/bin/cortetsu-updater",
    "caelestia/bin/cortetsu-updater-commit-base",
    ...
    "scripts/features/install-cortetsu-updater.sh",
    "scripts/features/update-cortetsu-updater.sh",
    "scripts/features/validate-cortetsu-updater.py",
