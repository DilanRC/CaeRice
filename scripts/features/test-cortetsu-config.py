...
for marker in ("CortetsuConfig.dashboard", "CortetsuConfig.launcher", "CortetsuConfig.sidebar", "CortetsuConfig.utilities", "CortetsuConfig.bar.workspaces", "CortetsuConfig.useFuzzyActions", "CortetsuConfig.useFuzzySchemes", "CortetsuConfig.useFuzzyVariants"):
    assert marker in (panel_sources + workspace_sources), marker
