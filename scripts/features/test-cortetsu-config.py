...
for marker in ("favouriteApps", "hiddenApps", "hiddenTrayIcons", "terminalCommand", "actionPrefix", "specialPrefix", "actions", "enableDangerousActions", "useFuzzyApps", "vimKeybinds", "workspacesShown", "function load", "function save", "function setFavouriteApps", "function setHiddenApps", "function setHiddenTrayIcons", "function setWorkspacesShown"):
