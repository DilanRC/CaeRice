...
for marker in ("CortetsuConfig.dashboard", "CortetsuConfig.launcher", "CortetsuConfig.sidebar", "CortetsuConfig.utilities", "CortetsuConfig.bar", "CortetsuConfig.bar.workspaces", "CortetsuConfig.bar.tray", "CortetsuConfig.bar.activeWindow", "CortetsuConfig.bar.popouts", "CortetsuConfig.bar.clock", "CortetsuConfig.notificationGroupPreviewNum", "CortetsuConfig.dashboardMediaUpdateInterval", "CortetsuConfig.nexusNetworkRescanInterval", "CortetsuConfig.useFuzzyActions", "CortetsuConfig.useFuzzySchemes", "CortetsuConfig.useFuzzyVariants"):
    assert marker in (panel_sources + workspace_sources + bar_sources + nexus_sources), marker
