...
for marker in ("favouriteApps", "hiddenTrayIcons", "terminalCommand", "actionPrefix", "workspacesShown", "function load", "function save", "function setFavouriteApps", "function setHiddenTrayIcons", "function setWorkspacesShown"):
