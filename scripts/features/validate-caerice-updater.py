...
paths=[MOD/'UpdaterController.qml',MOD/'updater/Wrapper.qml',MOD/'updater/Content.qml']+helpers
...
print('status: OK'); print('discover/status: valid'); print('package update: separate by design'); print('apply: explicit confirmation + snapshot + verify + rollback guarded'); print('patch-base commit: guarded, local-only, blocks unrelated dirty files')
