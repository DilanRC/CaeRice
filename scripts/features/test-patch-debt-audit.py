...
Locks in the audit result: the 10 patches this session owned are ACTIVE
...
AUDITED_ACTIVE_PATCHES = {
    ...
    "components__misc__CustomShortcut.qml.patch": (
...
def main() -> None:
    ...
    print("PASS: all 10 audited patches confirmed ACTIVE (Bottom Hub v4 migration engine)")
